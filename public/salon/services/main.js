...
async function getServies() {
    try {
        ...
        const result = await axios.get('http://54.162.57.159:3000/get-salon-services', { headers: { 'Auth': token } });
...
async function deleteService(id){
    try{
        ...
        const res=await axios.delete(`http://54.162.57.159:3000/delete-service/${id}`,{headers:{'Auth':token}});
