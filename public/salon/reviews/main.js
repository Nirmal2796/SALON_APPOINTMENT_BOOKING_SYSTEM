...
async function getReviews() {
    try {
        ...
        const result = await axios.get('http://54.162.57.159:3000/get-reviews', { headers: { 'Auth': token } });
...
reviewsList.addEventListener("submit", async function (e) {
    if (e.target.classList.contains("reply-form")) {
        ...
        const result = await axios.post(`http://54.162.57.159:3000/add-reply/${reviewId}`, { replyText }, { headers: { 'Auth': token } });
