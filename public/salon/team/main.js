...
async function setRegularShift(e) {
  ...
  const res=await axios.post('http://54.162.57.159:3000/set-regular_shift',data, {headers : {'Auth': token}});
...
async function addEmployee(e) {
    ...
    try{
        ...
        const res=await axios.post('http://54.162.57.159:3000/add-employee',employee, {headers : {'Auth': token}});
...
async function getRegularShift() {
  ...
  const res=await axios.get('http://54.162.57.159:3000/get-regular-shift',{headers : {'Auth': token}});
...
async function getEmployees() {
    ...
    try {
        ...
        const res=await axios.get('http://54.162.57.159:3000/get-employees',{headers:{'Auth':token}});
