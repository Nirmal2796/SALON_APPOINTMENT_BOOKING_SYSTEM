...
async function editProfile(e) {
    ...
    try {
        ...
        const res = await axios.post('http://54.162.57.159:3000/edit-salon-profile', user, { headers: { 'Auth': token } });
    }
    catch (err) {
        console.log(err);
    }
...
async function getUserDetails() {
    ...
    try {
        const res = await axios.get('http://54.162.57.159:3000/get-salon', { headers: { 'Auth': token } });
