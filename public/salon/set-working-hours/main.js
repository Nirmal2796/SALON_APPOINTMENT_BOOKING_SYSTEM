...
async function setWorkingHours(e) {
  ...
  const res=await axios.post('http://52.54.180.45:3000/set-working-hours',data, {headers : {'Auth': token}});
...
async function setClosedPeriod(e) {
    ...
    try{
        ...
        const res=await axios.post('http://52.54.180.45:3000/set-closed-period',closed_period, {headers : {'Auth': token}});
...
async function getWorkingHours() {
  ...
  const res=await axios.get('http://52.54.180.45:3000/get-working-hours',{headers : {'Auth': token}});
...
async function getClosedPeriod() {
    ...
    try {
        ...
        const closed_period=await axios.get('http://52.54.180.45:3000/get-closed-period',{headers:{'Auth':token}});
...
async function deleteClosedPeriod(id){
    try{
        ...
        const res=await axios.delete(`http://52.54.180.45:3000/delete-closed-period/${id}`,{headers:{'Auth':token}});
